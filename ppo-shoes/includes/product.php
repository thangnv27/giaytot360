...
function create_product_taxonomies(){
    ...
    register_taxonomy('product_color', 'product', array(
        ...
        'rewrite' => array('slug' => 'mau-sac', 'with_front' => false),
    ));
    register_taxonomy('product_size', 'product', array(
        ...
        'rewrite' => array('slug' => 'size', 'with_front' => false),
    ));
    register_taxonomy('product_brand', 'product', array(
        ...
        'labels' => array(
            'name' => __('Thương hiệu'),
            'singular_name' => __('Product Brands'),
            'add_new' => __('Add New'),
            'add_new_item' => __('Add New Brand'),
            'new_item' => __('New Brand'),
            'search_items' => __('Search Brands'),
        ),
        'rewrite' => array('slug' => 'thuong-hieu', 'with_front' => false),
    ));
    register_taxonomy('product_material', 'product', array(
        'hierarchical' => true,
        'public' => false,
        'show_ui' => true,
        'query_var' => true,
    ...
    register_taxonomy('product_type', 'product', array(
        ...
        'labels' => array(
            'name' => __('Kiểu dáng'),
            'singular_name' => __('Product Types'),
            'add_new' => __('Add New'),
            'add_new_item' => __('Add New Type'),
            'new_item' => __('New Type'),
            'search_items' => __('Search Types'),
        ),
        'rewrite' => array('slug' => 'kieu-dang', 'with_front' => false),
    ));
...
function product_save_quick_edit_data($post_id) {
    ...
    $fields = array('gia_cu', 'gia_moi', 'tinh_trang');
