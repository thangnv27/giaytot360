...
$options = array(
    ...
    'theme-options' => array(
        ...
        array("name" => "Liên hệ",
            ...
            "type" => "select",
            "options" => $page_list),
        array("name" => "Sản phẩm mới nhất",
            "desc" => "Sản phẩm mới nhất.",
            "id" => SHORT_NAME . "_pageNewProductID",
            "std" => '',
            "type" => "select",
            "options" => $page_list),
        array("name" => "Sản phẩm bán chạy nhất",
            "desc" => "Sản phẩm bán chạy nhất.",
            "id" => SHORT_NAME . "_pagesellID",
            "std" => '',
            "type" => "select",
            "options" => $page_list),
        array("name" => "Sản phẩm giảm giá",
            "desc" => "Sản phẩm giảm giá.",
            "id" => SHORT_NAME . "_pagesaleoffID",
            "std" => '',
            "type" => "select",
            "options" => $page_list),
